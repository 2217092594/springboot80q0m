...
CREATE TABLE `discussshangpinqiugou` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1614006254510 DEFAULT CHARSET=utf8 COMMENT='废品求购评论表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `discussshangpinxinxi` (
  ...
  `reply` longtext COMMENT '回复内容',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1614006223360 DEFAULT CHARSET=utf8 COMMENT='废品信息评论表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ershoudingdan` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `shangpinbianhao` varchar(200) DEFAULT NULL COMMENT '废品编号',
  `shangpinmingcheng` varchar(200) DEFAULT NULL COMMENT '废品名称',
  `shangpinleibie` varchar(200) DEFAULT NULL COMMENT '废品类别',
  `ershoujia` varchar(200) DEFAULT NULL COMMENT '废品价',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1614006237388 DEFAULT CHARSET=utf8 COMMENT='废品订单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ershoudingdan` VALUES (51,'2021-02-22 07:47:30','废品编号1','废品名称1','废品类别1','废品价1','卖家账号1','用户名1','姓名1','收货地址1','13823888881','未支付'),(52,'2021-02-22 07:47:30','废品编号2','废品名称2','废品类别2','废品价2','卖家账号2','用户名2','姓名2','收货地址2','13823888882','未支付'),(53,'2021-02-22 07:47:30','废品编号3','废品名称3','废品类别3','废品价3','卖家账号3','用户名3','姓名3','收货地址3','13823888883','未支付'),(54,'2021-02-22 07:47:30','废品编号4','废品名称4','废品类别4','废品价4','卖家账号4','用户名4','姓名4','收货地址4','13823888884','未支付'),(55,'2021-02-22 07:47:30','废品编号5','废品名称5','废品类别5','废品价5','卖家账号5','用户名5','姓名5','收货地址5','13823888885','未支付'),(56,'2021-02-22 07:47:30','废品编号6','废品名称6','废品类别6','废品价6','卖家账号6','用户名6','姓名6','收货地址6','13823888886','未支付'),(1614006237387,'2021-02-22 15:03:56','1614006083060','第三方水电费g','数码电子','800','456','123','十大','是大法官发给单方事故放到','13233221122','已支付');
...
CREATE TABLE `shangpinfenlei` (
  ...
  `shangpinleibie` varchar(200) DEFAULT NULL COMMENT '废品类别',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1614005972275 DEFAULT CHARSET=utf8 COMMENT='废品分类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shangpinfenlei` VALUES (31,'2021-02-22 07:47:30','废品类别1'),(32,'2021-02-22 07:47:30','废品类别2'),(33,'2021-02-22 07:47:30','废品类别3'),(34,'2021-02-22 07:47:30','废品类别4'),(35,'2021-02-22 07:47:30','废品类别5'),(36,'2021-02-22 07:47:30','废品类别6'),(1614005972274,'2021-02-22 14:59:31','数码电子');
...
CREATE TABLE `shangpinqiugou` (
  ...
  `shangpinmiaoshu` longtext COMMENT '废品描述',
  `sfsh` varchar(200) DEFAULT '否' COMMENT '是否审核',
  `shhf` longtext COMMENT '审核回复',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1614006070036 DEFAULT CHARSET=utf8 COMMENT='废品求购';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shangpinqiugou` VALUES (61,'2021-02-22 07:47:30','标题1','http://localhost:8080/springboot80q0m/upload/shangpinqiugou_tupian1.jpg','废品类别1','新旧程度1','可接受价格1','用户名1','品牌1','废品描述1','是',''),(62,'2021-02-22 07:47:30','标题2','http://localhost:8080/springboot80q0m/upload/shangpinqiugou_tupian2.jpg','废品类别2','新旧程度2','可接受价格2','用户名2','品牌2','废品描述2','是',''),(63,'2021-02-22 07:47:30','标题3','http://localhost:8080/springboot80q0m/upload/shangpinqiugou_tupian3.jpg','废品类别3','新旧程度3','可接受价格3','用户名3','品牌3','废品描述3','是',''),(64,'2021-02-22 07:47:30','标题4','http://localhost:8080/springboot80q0m/upload/shangpinqiugou_tupian4.jpg','废品类别4','新旧程度4','可接受价格4','用户名4','品牌4','废品描述4','是',''),(65,'2021-02-22 07:47:30','标题5','http://localhost:8080/springboot80q0m/upload/shangpinqiugou_tupian5.jpg','废品类别5','新旧程度5','可接受价格5','用户名5','品牌5','废品描述5','是',''),(66,'2021-02-22 07:47:30','标题6','http://localhost:8080/springboot80q0m/upload/shangpinqiugou_tupian6.jpg','废品类别6','新旧程度6','可接受价格6','用户名6','品牌6','废品描述6','是',''),(1614006070035,'2021-02-22 15:01:10','阿斯蒂芬稍等防守打法萨德','http://localhost:8080/springboot80q0m/upload/1614006049730.jpg','数码电子','8成','1000左右','123','苹果','打分个地方官奋斗过水电费个的飞洒','是','对方过后发给和法国队和发给');
...
CREATE TABLE `shangpinxinxi` (
  ...
  `shangpinmingcheng` varchar(200) DEFAULT NULL COMMENT '废品名称',
  `shangpinleibie` varchar(200) DEFAULT NULL COMMENT '废品类别',
  `shangpinguige` varchar(200) DEFAULT NULL COMMENT '废品规格',
  `tupian` varchar(200) DEFAULT NULL COMMENT '图片',
  `xinjiuchengdu` varchar(200) DEFAULT NULL COMMENT '新旧程度',
  `pinpai` varchar(200) DEFAULT NULL COMMENT '品牌',
  `yuanjia` varchar(200) DEFAULT NULL COMMENT '原价',
  `ershoujia` int(11) DEFAULT NULL COMMENT '废品价',
  `maijiazhanghao` varchar(200) DEFAULT NULL COMMENT '卖家账号',
  `maijiaxingming` varchar(200) DEFAULT NULL COMMENT '卖家姓名',
  `shangpinjieshao` longtext COMMENT '废品介绍',
  `sfsh` varchar(200) DEFAULT '否' COMMENT '是否审核',
  `shhf` longtext COMMENT '审核回复',
...
) ENGINE=InnoDB AUTO_INCREMENT=1614006117700 DEFAULT CHARSET=utf8 COMMENT='废品信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shangpinxinxi` VALUES (41,'2021-02-22 07:47:30','废品编号1','废品名称1','废品类别1','废品规格1','http://localhost:8080/springboot80q0m/upload/shangpinxinxi_tupian1.jpg','新旧程度1','品牌1','原价1',1,'卖家账号1','卖家姓名1','废品介绍1','是','',1,1),(42,'2021-02-22 07:47:30','废品编号2','废品名称2','废品类别2','废品规格2','http://localhost:8080/springboot80q0m/upload/shangpinxinxi_tupian2.jpg','新旧程度2','品牌2','原价2',2,'卖家账号2','卖家姓名2','废品介绍2','是','',2,2),(43,'2021-02-22 07:47:30','废品编号3','废品名称3','废品类别3','废品规格3','http://localhost:8080/springboot80q0m/upload/shangpinxinxi_tupian3.jpg','新旧程度3','品牌3','原价3',3,'卖家账号3','卖家姓名3','废品介绍3','是','',3,3),(44,'2021-02-22 07:47:30','废品编号4','废品名称4','废品类别4','废品规格4','http://localhost:8080/springboot80q0m/upload/shangpinxinxi_tupian4.jpg','新旧程度4','品牌4','原价4',4,'卖家账号4','卖家姓名4','废品介绍4','是','',4,4),(45,'2021-02-22 07:47:30','废品编号5','废品名称5','废品类别5','废品规格5','http://localhost:8080/springboot80q0m/upload/shangpinxinxi_tupian5.jpg','新旧程度5','品牌5','原价5',5,'卖家账号5','卖家姓名5','废品介绍5','是','',5,5),(46,'2021-02-22 07:47:30','废品编号6','废品名称6','废品类别6','废品规格6','http://localhost:8080/springboot80q0m/upload/shangpinxinxi_tupian6.jpg','新旧程度6','品牌6','原价6',6,'卖家账号6','卖家姓名6','废品介绍6','是','',6,6),(1614006117699,'2021-02-22 15:01:57','1614006083060','第三方水电费g','数码电子','单方事故的飞洒','http://localhost:8080/springboot80q0m/upload/1614006093129.jpg','全新','的飞洒','1900',800,'456','第三方','<p>发给很反感的恢复规划法国队和发货发给很反感的</p>','是','管理员审核通过才会在前台展示',1,1);
...
-- Dump completed on 2021-02-23 10:09:41
