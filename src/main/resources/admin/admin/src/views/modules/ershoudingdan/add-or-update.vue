      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="废品编号" prop="shangpinbianhao">
          <el-input v-model="ruleForm.shangpinbianhao" 
              placeholder="废品编号" clearable  :readonly="ro.shangpinbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="废品编号" prop="shangpinbianhao">
              <el-input v-model="ruleForm.shangpinbianhao" 
          ...
          <el-form-item class="input" label="废品名称" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="废品名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="废品类别" prop="shangpinleibie">
          <el-input v-model="ruleForm.shangpinleibie" 
              placeholder="废品类别" clearable  :readonly="ro.shangpinleibie"></el-input>
        </el-form-item>
        <div v-else>
