<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="废品编号" prop="shangpinbianhao">
            <el-input v-model="ruleForm.shangpinbianhao" 
                placeholder="废品编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangpinbianhao" label="废品编号" prop="shangpinbianhao">
              <el-input v-model="ruleForm.shangpinbianhao" 
                placeholder="废品编号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="废品名称" prop="shangpinmingcheng">
          <el-input v-model="ruleForm.shangpinmingcheng" 
              placeholder="废品名称" clearable  :readonly="ro.shangpinmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="废品名称" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="废品名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="废品类别" prop="shangpinleibie">
          <el-select v-model="ruleForm.shangpinleibie" placeholder="请选择废品类别">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="废品类别" prop="shangpinleibie">
	      <el-input v-model="ruleForm.shangpinleibie"
                placeholder="废品类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="废品规格" prop="shangpinguige">
          <el-input v-model="ruleForm.shangpinguige" 
              placeholder="废品规格" clearable  :readonly="ro.shangpinguige"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="废品规格" prop="shangpinguige">
              <el-input v-model="ruleForm.shangpinguige" 
                placeholder="废品规格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
          ...
          <el-form-item class="input" label="原价" prop="yuanjia">
              <el-input v-model="ruleForm.yuanjia" 
                placeholder="原价" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="废品价" prop="ershoujia">
          <el-input v-model="ruleForm.ershoujia" 
              placeholder="废品价" clearable  :readonly="ro.ershoujia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="废品价" prop="ershoujia">
              <el-input v-model="ruleForm.ershoujia" 
                placeholder="废品价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="卖家姓名" prop="maijiaxingming">
              <el-input v-model="ruleForm.maijiaxingming" 
                placeholder="卖家姓名" readonly></el-input>
                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="废品介绍" prop="shangpinjieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shangpinjieshao" label="废品介绍" prop="shangpinjieshao">
